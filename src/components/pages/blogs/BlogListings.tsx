...
import BlogCard, { BlogData } from './BlogCard.tsx';
...
const BlogListings: React.FC<BlogListProps> = ({ apiUrl }) => {
    ...
    return (
        <div>
            <div className="section-dark page-banner list-banner-home for-listing-page more-height half-height sect-blog" >
                ...
                <div className="container h-100-per blog-list-li">
                            ...
                            <>
                                {fetchedProperties.length > 0 ? (
                                    fetchedProperties.map((property, index) => (
                                        <BlogCard key={`${property.id}-${index}`} property={property} />
                                    ))
                                ) : (
                                    <NoData />
                                )}
